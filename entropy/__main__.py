...
# this function should return either a table or a file based on what backend
# you use. So read the backend from this_engine_cfg, and then return either
# a table or a file.
...
def get_cfg_file(engine, script_type):
    ...
    try:
        ...
        x = this_engine_cfg[engine]['backend']
        backend = Engine.get_backend(x, this_engine_cfg[engine])
