...
class Engine(object):
    ...
    def setup_audit(self, execution_time, audit_list):
        try:
            print utils.wallclock(), "waiting till", execution_time
            ...
            for audit in audit_list:
                ...
                future = self.executor.submit(self.run_audit, audit_name=audit_name,
                                              **audit_cfg)
    ...
    def foo(self, name, **script_args):
        print 'hello world'

    def run_audit(self, audit_name, **audit_cfg):
        print "####",audit_name, audit_cfg
        # Read the conf file
        data = audit_cfg
